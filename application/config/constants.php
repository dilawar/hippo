...
$dbChoices = array(
    ...
    , 'events.class' =>
        'UNKNOWN,TALK,INFORMAL TALK,PUBLIC TALK,LECTURE,PUBLIC LECTURE' .
        ',MEETING,LAB MEETING,THESIS COMMITTEE MEETING,JOURNAL CLUB MEETING' .
    ...
    , 'venues.type' =>
        ...
        ',UNKNOWN,CONFERENCE ROOM,REMOTE VC'
    , 'talks.class' =>
        'INFORMAL TALK,PUBLIC TALK,PUBLIC LECTURE' .
        ',SEMINAR,PRESYNOPSIS THESIS SEMINAR,THESIS SEMINAR' .
        ',SIMONS SEMINAR,INFORMAL SIMONS TALK,ANNUAL WORK SEMINAR' .
        ',SIMONS COLLOQUIA,SIMONS LECTURE SERIES,WORKSHOP'
    , 'bookmyvenue.class' =>
        'UNKNOWN,TALK,INFORMAL TALK' .
        ',MEETING,LAB MEETING,THESIS COMMITTEE MEETING,JOURNAL CLUB MEETING' .
