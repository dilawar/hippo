...
echo printInfo(
    'Admin is allowed to reformat the entry and change venue information. 
...
if (!$aws) {
    ...
    echo dbTableToHTMLTable('upcoming_aws', $aws, 'vc_url,abstract,title,is_presynopsis_seminar,supervisor_1', 'Update AWS Entry');
    echo '</form>';
}
