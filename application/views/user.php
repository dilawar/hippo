...
<div class="row">
    <div class="col card text-center m-3 p-1">
        <a class="fa fa-book fa-2x clickable" 
...
<?php if( __get__($cUserInfo, 'eligible_for_aws', 'NO' ) == 'YES'): ?>
    <div class="col card m-3 p-1 text-center">
        <a class="fa fa-graduation-cap clickable" 
...
<div class="row">
<div class="col card text-center m-3 p-1">
     <a class="clickable fa fa-hand-pointer-o fa-2x" 
    ...
    <br /> <br /> 
    <a class="fa fa-pencil-square-o fa-1x" 
        href="<?=site_url("/user/show_private")?>">
        Manage My Private Events ('<?=$flag?>)
    </a> 
</div>
<div class="col card text-center m-3 p-1">
    <a class="fa fa-comments fa-2x clickable" 
...
<div class="col card text-center m-3 p-1">
     <a class="clickable fa fa-flask fa-2x" 
...
<?php if(anyOfTheseRoles('ADMIN,BOOKMYVENUE_ADMIN,JOURNALCLUB_ADMIN,ACAD_ADMIN')): ?>
    ...
    <?php if(in_array("ADMIN", $roles)): ?>
       <div class="col card text-center m-3 p-1"> 
            <a class="clickable fa fa-lock fa-2x" 
    ...
    <?php if(in_array("BOOKMYVENUE_ADMIN", $roles)): ?>
       <div class="col card text-center m-3 p-1">
           <a class="clickable fa fa-calendar-plus-o fa-2x" 
                href="<?=site_url("/adminbmv")?>"> BookMyVenue Admin</a>
       </div>
    <?php else: ?>
       <div class="col card text-center m-3 p-1"></div>
    <?php endif; ?>

    <?php if( in_array( "ACAD_ADMIN", $roles)): ?>
       <div class="col card text-center m-3 p-1">
            <a class="clickable fa fa-graduation-cap fa-2x" 
...
<?php if(anyOfTheseRoles("SERVICES_ADMIN")): ?>
    ...
    <div class="row">
        <div class="col card text-center m-3 p-1">
            <a class="clickable fa fa-bus fa-2x" 
                href="<?=site_url( 'adminservices/transport')?>">Manage Transport</a>
        </div>
        <div class="col card text-center m-3 p-1">
            <a class="clickable fa fa-cutlery fa-2x"
