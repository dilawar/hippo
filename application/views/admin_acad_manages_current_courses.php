...
$default = [
    'venue' => $venueSelect, 'semester' => $semester, 'year' => $year, 'course_id' => $courseIdsSelect,
];
...
if (__get__($_POST, 'running_course', '')) {
    ...
    $action = 'Update';
    $course = getTableEntry('courses', 'id', ['id' => $_POST['running_course_id']]);
    $default['semester'] = $semester;

    // Select the already assigned venue.
    $venueSelect = venuesToHTMLSelect($venues, false, 'venue', [$course['venue']]);
    $default['venue'] = $venueSelect;
